  ...
  return (
    <div key={index} className={`inline-flex text-left text-white ${message.isIncoming ? "incoming-message" : "outgoing-message"} pop-in`}>
      <div className="message-info flex flex-col border-2 border-gray-500 box-border w-full rounded-lg p-2">
        ...
        {message.url && (
          <>
            <a href={message.url} target="_blank" className="text-white w-fit bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">Visit Current Page</a>
          </>
        )}
